...
pkgname='ros-kinetic-velodyne-simulator'
pkgver='1.0.6_1'
pkgrel=1
arch=('any')
license=('BSD'
...
depends=('ros-kinetic-velodyne-description'
...
_dir=velodyne_simulator
source=()
md5sums=()

prepare() {
    cp -R $startdir/velodyne_simulator $srcdir/velodyne_simulator
}
